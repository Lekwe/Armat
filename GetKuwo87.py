...
while True:
    ...
    if returns:
        while True:
            ...
            url = "http://www.kuwo.cn/url?format=mp3&rid={}&response=url&type=convert_url3&br=128kmp3&from=web&t=1612769264838&httpsStatus=1&reqId=22dbdd71-69df-11eb-be09-47f3f4fea7e7".format(
                songid)
            headers = {
